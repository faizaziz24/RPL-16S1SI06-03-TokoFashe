...
if (isset($_GET['pages'])){
	switch ($_GET['pages']){	
		...
		case 'buy-product'	: if(!file_exists ("pages/shop/shop-buy-item.php")) die ("File Beli Produk tidak ada");
								include "pages/shop/shop-buy-item.php"; break;

		case 'cart-product'	: if(!file_exists ("pages/shop/cart-product.php")) die ("File Keranjang Produk Pembelian tidak ada");
								include "pages/shop/cart-product.php"; break;

		case 'trans-buying'	: if(!file_exists ("pages/transaction-buying.php")) die ("File Transaksi Pembelian tidak ada");
								include "pages/transaction-buying.php"; break;

		case 'detail-buying': if(!file_exists ("pages/detail-buying.php")) die ("File Detail Pembelian tidak ada");
								include "pages/detail-buying.php"; break;						
