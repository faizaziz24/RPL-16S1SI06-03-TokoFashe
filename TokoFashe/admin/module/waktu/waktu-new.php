<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-plus"></i> Waktu Baru</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-6">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="../admin/module/waktu/waktu-new-aksi.php" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Lama Buat</label>
                  <div class="col-sm-9">
                    <input type="text" name="lama_waktu" class="form-control" placeholder="Lama Waktu">
                  </div>
                </div>
                <div class="form-group">
